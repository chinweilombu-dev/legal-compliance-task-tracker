...
![photo of project demo page](https://github.com/chinweilombu-dev/legal-compliance-task-tracker/blob/c176f3067767892fc1aa1bc357b739335b83b272/demo1.png)

## Features

\- Create, view, update and delete tasks (CRUD)

\- Task categorisation (e.g. Contracts, Data Protection)

\- Status tracking with overdue detection

\- Dashboard summary for visibility
...
\- option to upload relevant documents/links alongside each task
